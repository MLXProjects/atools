...
if "%LIBAROMA_JPEG%"=="yes" (
	set LIBAROMA_CFLAGS=!LIBAROMA_CFLAGS! -I..\..\jpeg
) else set LIBAROMA_CFLAGS=!LIBAROMA_CFLAGS! -DLIBAROMA_CONFIG_NOJPEG
if "%LIBAROMA_DRM%"=="yes" (
	set LIBAROMA_CFLAGS=!LIBAROMA_CFLAGS! -I..\..\drm
) else set LIBAROMA_CFLAGS=!LIBAROMA_CFLAGS! -DLIBAROMA_CONFIG_NODRM
...
if "%LIBAROMA_DEBUG%"=="yes" set LIBAROMA_CFLAGS=!LIBAROMA_CFLAGS! -DLIBAROMA_CONFIG_DEBUG_TRACE=3
if "%LIBAROMA_MEMDEBUG%"=="yes" set LIBAROMA_CFLAGS=!LIBAROMA_CFLAGS! -DLIBAROMA_CONFIG_DEBUG_MEMORY=1
